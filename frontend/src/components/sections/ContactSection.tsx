  ...
  return (
    <section id="contact" className="min-h-screen flex items-center justify-center px-8 py-20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="bg-navy-800/40 backdrop-blur-md rounded-2xl p-10 border border-teal-400/20 max-w-lg hover:border-teal-400/40 hover:shadow-xl hover:shadow-teal-400/10 transition-all duration-300">
